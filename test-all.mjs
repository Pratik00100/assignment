...
try {
  ...
  if (ids === 'apify,gmail,memory,notion') pass('all 4 bundled reference plugins discovered (apify, gmail, memory, notion)');
  else fail(`bundled plugins = "${ids}" (expected apify,gmail,memory,notion)`);
